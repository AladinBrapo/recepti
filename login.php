...
<body class="bg-[#99431f] font-['Poppins']">
  ...
  <div class="mobile-view">
    <div class="YummiesRecipesPhoneLogin w-[360px] h-[800px] relative bg-[#99431f]">
        ...
        <div class="PhoneSmallButtonVariant2 w-[150px] h-10 px-[12.38px] py-[6.19px] left-[105px] top-[526px] absolute bg-[#ffd633] rounded-xl flex items-center justify-center">
            <button class="Button text-center text-[#010012] text-xs font-normal font-['Poppins'] capitalize">Log In</button>
        </div>
