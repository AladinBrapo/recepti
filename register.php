...
<body class="bg-[#99431f] font-['Poppins']">
  <div class="desktop-view"> 
    <div class="w-full sm:w-[1920px]">
        <div class="YummiesRecipesDesktopRegister w-[1920px] h-[1796px] relative bg-[#99431f]">
            ...
            <div class="Frame427320860 w-[323px] h-[57px] left-[1043px] top-[702px] absolute bg-white rounded-[3px] shadow border border-black"></div>
            <div class="Frame427320859 w-[323px] h-[57px] left-[673px] top-[702px] absolute bg-white rounded-[3px] shadow border border-black"></div>
            ...
            <div class="ButtonVariant2 w-[323px] h-[45.52px] px-[21.68px] py-[10.84px] left-[839px] top-[973.24px] absolute bg-[#ffd633] rounded-[108.39px] justify-between items-center inline-flex">
  ...
  <div class="mobile-view">
    <div class="YummiesRecipesPhoneRegister w-[360px] h-[800px] relative bg-[#99431f]">
        ...
        <div class="TitleNormal w-[73.98px] h-[34.48px] left-[64px] top-[474.47px] absolute">
        ...
        <div class="TitleNormal w-[73.98px] h-[34.48px] left-[60px] top-[264px] absolute">
            <div class="HeaderNormal left-0 top-0 absolute text-white text-[22.98px] font-medium font-['Poppins'] capitalize">Name</div>
        </div>
        ...
        <div class="TitleNormal w-28 h-[34.48px] left-[60px] top-[369px] absolute">
            <div class="HeaderNormal left-0 top-0 absolute text-white text-[22.98px] font-medium font-['Poppins'] capitalize">Surname</div>
        </div>
        ...
        <div class="Frame427320862 w-[232px] h-[40.94px] left-[60px] top-[308px] absolute bg-white rounded-sm shadow border border-black"></div>
        ...
        <div class="Frame427320863 w-[232px] h-[40.94px] left-[60px] top-[413.53px] absolute bg-white rounded-sm shadow border border-black"></div>
        ...
        <div class="PhoneSmallButtonVariant2 w-[150px] h-10 px-[12.38px] py-[6.19px] left-[105px] top-[699px] absolute bg-[#ffd633] rounded-xl flex items-center justify-center">
